      ...
      <section style={{ padding: "60px 0 96px", background: "var(--color-background)" }}>
        <div className="container-page" style={{ maxWidth: "800px" }}>
          <div style={contentStyle}>
            ...
            <p>
              For Australian users, we comply with the Australian Privacy Principles on cross-border disclosure. You may request more detail on these safeguards by emailing <a href="mailto:RenewPlusPrivacy@craftedbyellis.com" style={linkStyle}>RenewPlusPrivacy@craftedbyellis.com</a>.
            </p>
            ...
            <ul style={listStyle}>
              ...
              <li>If you cannot access the App, email <a href="mailto:RenewPlusPrivacy@craftedbyellis.com" style={linkStyle}>RenewPlusPrivacy@craftedbyellis.com</a> from your account email and we will delete your data on request.</li>
            ...
            <p>
              You have the right to access, correct, and withdraw consent for processing your personal information. Quebec residents additionally have data portability rights. Contact <a href="mailto:RenewPlusPrivacy@craftedbyellis.com" style={linkStyle}>RenewPlusPrivacy@craftedbyellis.com</a>. We respond within 30 days.
            </p>

            <h3 style={h3Style}>India, DPDP Act 2023</h3>
            <p>
              You have the right to access, correct, and erase your personal data, and to nominate another person to exercise these rights on your behalf. Contact <a href="mailto:RenewPlusPrivacy@craftedbyellis.com" style={linkStyle}>RenewPlusPrivacy@craftedbyellis.com</a>.
            </p>

            <h3 style={h3Style}>Singapore, PDPA</h3>
            <p>
              You have the right to access and correct personal data we hold, and to withdraw consent for its collection and use. Contact <a href="mailto:RenewPlusPrivacy@craftedbyellis.com" style={linkStyle}>RenewPlusPrivacy@craftedbyellis.com</a>.
            </p>
            ...
            <p style={{ marginTop: "12px" }}>
              ...
              Privacy enquiries: <a href="mailto:RenewPlusPrivacy@craftedbyellis.com" style={linkStyle}>RenewPlusPrivacy@craftedbyellis.com</a><br />
              General support: <a href="mailto:RenewPlusPrivacy@craftedbyellis.com" style={linkStyle}>RenewPlusPrivacy@craftedbyellis.com</a><br />
