...
export default function RenewPlusPrivacyPage() {
  return (
    <LegalPage
      ...
      version="Version date: 15 June 2026 · Effective: 15 June 2026"
      app="renew"
    >
            ...
            <ul>
              <li><strong>Google Firebase</strong> (Firestore, Authentication, Storage), operated by Google LLC, United States. Database, authentication, and file storage. <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">Privacy Policy</a></li>
              <li><strong>Anthropic, PBC</strong>, United States. Powers AI features (goal planning, recipe scanning). Data you submit to an AI feature is sent to Anthropic only to generate your result. Anthropic processes it as our service provider and does not use it to train its models. <a href="https://www.anthropic.com/privacy" target="_blank" rel="noopener noreferrer">Privacy Policy</a></li>
              <li><strong>Apple Inc.</strong> (StoreKit, App Store), United States. Subscription management and payments. Apple processes your payment data as an independent controller under its own terms. <a href="https://www.apple.com/legal/privacy/" target="_blank" rel="noopener noreferrer">Privacy Policy</a></li>
            </ul>
            ...
            <p>
              For Australian users, we comply with the Australian Privacy Principles on cross-border disclosure. You may request more detail on these safeguards by emailing <a href="mailto:RenewPlusPrivacy@craftedbyellis.com">RenewPlusPrivacy@craftedbyellis.com</a>.
            </p>
            ...
            <ul>
              ...
              <li><strong>Encrypted backups</strong>: held by Google Cloud, our infrastructure provider, and overwritten on their own rolling cycle. We do not control or configure that cycle, and we cannot purge their backups on request.</li>
            ...
            <ul>
              <li>Live data is removed immediately and irreversibly. Residual copies may persist for a period in our infrastructure provider&apos;s own backups, which are governed by their retention rather than ours (see Section 6).</li>
              <li><strong>Deletion is irreversible</strong>: we cannot recover deleted data.</li>
              <li>If you cannot access the App, email <a href="mailto:RenewPlusPrivacy@craftedbyellis.com">RenewPlusPrivacy@craftedbyellis.com</a> from your account email and we will delete your data on request.</li>
            ...
            <h3>Everyone, our global baseline</h3>
            ...
            <p>
              Most of these you can do yourself in the App (edit or delete data, export where available, toggle permissions). Otherwise email <a href="mailto:RenewPlusPrivacy@craftedbyellis.com">RenewPlusPrivacy@craftedbyellis.com</a>. We respond within <strong>30 days</strong> (sooner where local law requires) and never charge for a reasonable request. We will not discriminate against you for exercising these rights.
            </p>

            <h3>New Zealand, Privacy Act 2020</h3>
            <p>
              You have the right to request access to and correction of personal information we hold. We will respond within 20 working days. Complaints may be made to the <a href="https://www.privacy.org.nz" target="_blank" rel="noopener noreferrer">NZ Privacy Commissioner</a>.
            </p>

            <h3>Australia, Privacy Act 1988</h3>
            <p>
              You have the right to access and correct your personal information and to complain about breaches of the Australian Privacy Principles. Unresolved complaints may be escalated to the <a href="https://www.oaic.gov.au" target="_blank" rel="noopener noreferrer">Office of the Australian Information Commissioner (OAIC)</a>.
            </p>
            ...
            <p>
              You have the right to access, correct, and withdraw consent for processing your personal information. Quebec residents additionally have data portability rights. Contact <a href="mailto:RenewPlusPrivacy@craftedbyellis.com">RenewPlusPrivacy@craftedbyellis.com</a>. We respond within 30 days.
            </p>

            <h3>India, DPDP Act 2023</h3>
            <p>
              You have the right to access, correct, and erase your personal data, and to nominate another person to exercise these rights on your behalf. Contact <a href="mailto:RenewPlusPrivacy@craftedbyellis.com">RenewPlusPrivacy@craftedbyellis.com</a>.
            </p>

            <h3>Singapore, PDPA</h3>
            <p>
              You have the right to access and correct personal data we hold, and to withdraw consent for its collection and use. Contact <a href="mailto:RenewPlusPrivacy@craftedbyellis.com">RenewPlusPrivacy@craftedbyellis.com</a>.
            </p>
            ...
            <p>
              Renew+ is not directed at children under 13. We do not knowingly collect personal information from children under 13. If you believe a child has created an account, contact us at <a href="mailto:RenewPlusPrivacy@craftedbyellis.com">RenewPlusPrivacy@craftedbyellis.com</a> and we will delete the account promptly.
            </p>
            ...
            <p style={{ marginTop: "12px" }}>
              ...
              Privacy enquiries: <a href="mailto:RenewPlusPrivacy@craftedbyellis.com">RenewPlusPrivacy@craftedbyellis.com</a><br />
              General support: <a href="mailto:RenewPlusPrivacy@craftedbyellis.com">RenewPlusPrivacy@craftedbyellis.com</a><br />
