        ...
        <div className="container-page" style={{ maxWidth: "800px" }}>
          <div style={contentStyle}>
            <p style={{ marginBottom: "32px" }}>
              At Crafted by Ellis (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;), we take your privacy seriously. This Privacy Policy explains how we collect, use, and protect your information when you use Renew+.
            </p>
            ...
            <ul style={listStyle}>
              <li>Goals, journal entries, recipes, and financial data you create</li>
            ...
            <ul style={listStyle}>
              ...
              <li>Send important service updates (only when essential)</li>
            ...
            <p>
              Your data is stored securely using Firebase (Google Cloud) infrastructure with industry-standard security measures:
            </p>
            <ul style={listStyle}>
            ...
            <ul style={listStyle}>
              ...
              <li><strong>With your consent:</strong> If you explicitly opt-in to share with family members</li>
            </ul>
            ...
            <ul style={listStyle}>
              ...
              <li><strong>Withdraw consent:</strong> Opt out of analytics</li>
            </ul>
            ...
            <p>
              Your data may be processed in countries where Firebase operates servers, including the United States. By using Renew+, you consent to this transfer.
            </p>
