...
export default function RenewPlusTermsPage() {
  return (
    ...
    >
            ...
            <p>
              In some jurisdictions a higher minimum age applies to consent to the processing of personal data. Where that is the case, you must meet the higher age, or have verifiable parental consent, before using the App. See the <Link href="/renewplus/privacy">Privacy Policy</Link> for details.
            </p>
            <p>
            ...
            <ul>
              ...
              <li>Notify us immediately at <a href="mailto:RenewPlus@craftedbyellis.com">RenewPlus@craftedbyellis.com</a> if you suspect unauthorised access</li>
            ...
            <h2>9. Disclaimers: Not Financial, Tax, or Medical Advice</h2>
            <h3>Financial, tax, and KiwiSaver calculations</h3>
            <p>
            ...
            <h3>Health, nutrition, and wellness features</h3>
            <p>
            ...
            <h2>13. Apple App Store: Licensed Application Terms</h2>
            <p>
            ...
            <ul>
              ...
              <li><strong>Developer contact.</strong> Questions, complaints, or claims about the App should be directed to Braden Cole Ellis at <a href="mailto:RenewPlus@craftedbyellis.com">RenewPlus@craftedbyellis.com</a>, New Zealand.</li>
            ...
            <h2>15. Consumer Guarantees and Mandatory Rights</h2>
            <p>
            ...
            <h2>16. Changes to the App and Terms</h2>
            <p>
            ...
            <p>
              We may suspend or terminate your account if you breach these Terms or if we are required to do so by law. You may delete your account at any time from Settings → Delete Account, which permanently erases all your data as described in the <Link href="/renewplus/privacy">Privacy Policy</Link>. On termination, your licence to use the App ceases immediately.
            </p>

            <h2>18. Regional Consumer Rights</h2>
            <h3>Australia</h3>
            <p>
